...
const bases: BaseItem[] = [
  {
    ...
    type: "characters",
    count: 12,
    gradient: "from-rose-500/40 via-fuchsia-700/30 to-zinc-900",
  },
  {
    id: "locations",
    ...
    type: "locations",
    count: 8,
    gradient: "from-amber-500/40 via-orange-700/30 to-zinc-900",
  },
  {
    id: "props",
    title: "Sci-fi Props",
    type: "props",
    count: 23,
    gradient: "from-cyan-500/40 via-blue-700/30 to-slate-900",
  },
  {
    id: "audio",
    title: "Brand Sound Pack",
    type: "audio",
    count: 17,
    gradient: "from-purple-500/40 via-violet-700/30 to-slate-900",
  },
  {
    id: "storyboards",
    title: "Storyboard Drafts",
    type: "storyboards",
    count: 5,
    gradient: "from-emerald-500/40 via-teal-700/30 to-slate-900",
  },
];
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-2">
          <button className="btn-ghost">
            <Upload size={14} /> {t.bases_import}
          </button>
          <button className="btn-primary">
            <Plus size={14} /> {t.bases_new}
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <button
          className="corner-frame card flex flex-col items-center justify-center
                           aspect-[16/10] hover:bg-accent-dim/30 group"
        >
          <span className="c-tr" />
          <span className="c-bl" />
          <div
            className="w-14 h-14 rounded-full bg-bg-elevated border border-border
          ...
          return (
            <article key={b.id} className="card group cursor-pointer">
              <div className={`relative aspect-[16/10] bg-gradient-to-br ${b.gradient}`}>
                ...
                />
                <div
                  className="absolute top-3 left-3 w-9 h-9 rounded-lg bg-black/40 backdrop-blur
                                flex items-center justify-center text-white"
                >
                  <Icon size={18} />
                </div>
                <div
                  className="absolute bottom-3 right-3 px-2 py-0.5 rounded-md text-[11px]
