    ...
    >
      <article>
        <div className="relative aspect-[16/10] overflow-hidden bg-bg-elevated">
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-4">
            <div className="flex items-center justify-between">
              ...
              {item.duration && (
                <span
                  className="ml-auto px-2 py-0.5 rounded-md text-[11px] font-mono
          ...
          >
            <div
              className="w-14 h-14 rounded-full bg-accent text-bg flex items-center justify-center
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <span className="text-xs uppercase tracking-wider text-text-muted">{item.category}</span>
          <button
