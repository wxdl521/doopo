    ...
    case "scene":
      return {
        ...
        system:
          ...
          "action 是供后续场景生图、分镜和详情编辑复用的【扩写版无人环境描述】：在不改变剧本已给定地点、时段和氛围的前提下，扩写为 120-220 字。必须具体写出空间层次与景别、建筑或自然材质、陈设与无生命道具、天气、光线来源与方向、冷暖色调、空气感，以及可稳定复现的环境细节；不要写抽象评价或镜头外剧情。**严禁出现任何角色名、人名、人物称谓、人群、人物动作、对白、动物、宠物、神兽或其他生物；即使原文正在描写角色，也只能改写为不含生物的环境状态。**" +
              ...
              items: {
                ...
                properties: {
                  ...
                  action: {
                    type: "string",
                    description:
                      "120-220 字的扩写版无人环境描写；具体包含空间层次、材质陈设、天气、光线方向、色彩和空气感，只含建筑、空间、景观、天气、光影和无生命道具，严禁角色名、人物、动作、对白、动物或任何生物",
                  },
                  beats: {
                    type: "array",
                    items: { type: "string" },
                    description:
                      "可省略；最多 1-2 个环境变化或空间细节标签，严禁角色、人物动作、动物或其他生物",
                  },
                },
    ...
    case "character-extract":
      return {
        ...
        system:
          ...
          "**群体角色(2026/08 用户诉求)**:文本中以群体身份行动或说话的集合角色(如「美女们」「女DJ」「保安们」「同学们」)," +
          "**作为一个群体角色卡提取**:name 写群体名(如「美女们 · 夜店群像」),role 标 supporting," +
          "faceDescription/bodyDescription 写群体共同特征的范围(如「年轻女性群体,妆容精致,时尚感强」)," +
          "clothingDescription 写群体统一或同系列服装。只有有台词或明确剧情作用(说话、与主角互动、推动情节)的群体才提取;" +
          "纯背景人群(路人、围观群众、无台词的顾客)不提取。" +
