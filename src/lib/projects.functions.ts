  ...
  .handler(async ({ data, context }) => {
    ...
    return {
      workspaceData: {
        ...
        // 项目剧照状态 + 自动封面 URL（2026/08）；老项目无此字段,保持 undefined
        posterImage: fields.posterImage,
        autoCoverUrl: fields.autoCoverUrl,
