...
export async function callLovableGatewayImage(
  input: LovableImageInput,
): Promise<LovableImageResult> {
  ...
  try {
    ...
    if (first.b64_json)
      return { url: `data:image/png;base64,${first.b64_json}`, error: null, model };
