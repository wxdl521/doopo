...
export function exportScriptAsTxt(s: ExportableScript, labels: ExportLabels) {
  ...
  const text = [
    ...
    "",
    `${labels.type}: ${s.type}`,
    `${labels.genre}: ${Array.isArray(s.genre) ? s.genre.join("、") : s.genre}`,
    `${labels.tone}: ${Array.isArray(s.tone) ? s.tone.join("、") : s.tone}`,
    ...
    sections: [
      {
        ...
        children: [
          ...
          metaLine(labels.genre, Array.isArray(s.genre) ? s.genre.join("、") : s.genre),
          metaLine(labels.tone, Array.isArray(s.tone) ? s.tone.join("、") : s.tone),
