...
export const mockScripts: ScriptItem[] = [
  {
    ...
    versions: [
      { id: 'v1', label: 'v1 — Initial draft', createdAt: '2026-05-08', author: 'AI', note: 'Auto-generated from one-line idea.' },
      { id: 'v2', label: 'v2 — Tighter pacing', createdAt: '2026-05-09', author: 'Lin', note: 'Cut scene 4, condensed exposition.' },
      { id: 'v3', label: 'v3 — Conflict bump', createdAt: '2026-05-11', author: 'AI', note: 'Increased conflict density to 70%.' },
    ],
    scenes: [
      {
        id: 'sc-1',
      ...
      },
      {
        ...
        dialogue: [
          { role: 'MAYA (RADIO)', line: "Don't light the lamp tonight." },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    versions: [{ id: 'v1', label: 'v1 — Outline', createdAt: '2026-05-09', author: 'AI', note: 'Outline only.' }],
    scenes: [],
  },
]
...
export const mockTeamMembers: TeamMember[] = [
  { id: 'u-1', name: 'Lin Wu', email: 'lin@studio.com', role: 'owner', status: 'active', joined: '2025-09-01', lastActive: '2 min ago', pointsUsed: 1248 },
  { id: 'u-2', name: 'Ada Reyes', email: 'ada@studio.com', role: 'admin', status: 'active', joined: '2025-10-12', lastActive: '15 min ago', pointsUsed: 932 },
  { id: 'u-3', name: 'Tomás Vela', email: 'tomas@studio.com', role: 'editor', status: 'active', joined: '2025-11-03', lastActive: '1 hour ago', pointsUsed: 510 },
  { id: 'u-4', name: 'Hana Mori', email: 'hana@studio.com', role: 'editor', status: 'invited', joined: '2026-05-10', lastActive: '—', pointsUsed: 0 },
  { id: 'u-5', name: 'Riku Sato', email: 'riku@studio.com', role: 'viewer', status: 'suspended', joined: '2025-12-19', lastActive: '5 days ago', pointsUsed: 22 },
]
...
export const mockAuditLogs: AuditLog[] = [
  { id: 'l-1', ts: '2026-05-12 09:14', actor: 'Lin Wu', action: 'Generated script', target: 'scr-001 v3', ip: '203.0.113.10' },
  { id: 'l-2', ts: '2026-05-12 08:51', actor: 'Ada Reyes', action: 'Approved export', target: 'project Lighthouse Reverie', ip: '203.0.113.18' },
  { id: 'l-3', ts: '2026-05-12 08:02', actor: 'Tomás Vela', action: 'Created character', target: 'ch-vendor', ip: '198.51.100.4' },
  { id: 'l-4', ts: '2026-05-11 22:47', actor: 'Lin Wu', action: 'Invited member', target: 'hana@studio.com', ip: '203.0.113.10' },
  { id: 'l-5', ts: '2026-05-11 18:22', actor: 'Riku Sato', action: 'Login failed', target: '—', ip: '198.51.100.77' },
  { id: 'l-6', ts: '2026-05-11 14:05', actor: 'Ada Reyes', action: 'Locked character', target: 'ch-maya', ip: '203.0.113.18' },
]
...
export const mockApprovals: ApprovalRequest[] = [
  { id: 'a-1', requester: 'Tomás Vela', type: 'export', target: 'Lighthouse Reverie — 1080p MP4', requestedAt: '2026-05-12 09:00', status: 'pending' },
  { id: 'a-2', requester: 'Hana Mori', type: 'share', target: 'Character ch-vendor', requestedAt: '2026-05-12 08:30', status: 'pending' },
  { id: 'a-3', requester: 'Tomás Vela', type: 'export', target: 'Founder Story Pitch — script.pdf', requestedAt: '2026-05-11 17:42', status: 'approved' },
  { id: 'a-4', requester: 'Riku Sato', type: 'delete', target: 'Asset render-0091', requestedAt: '2026-05-10 10:11', status: 'rejected' },
]
...
export const mockTenants: Tenant[] = [
  { id: 't-1', company: 'Aurora Studio', plan: 'studio', seats: 12, status: 'active', created: '2025-08-12', contact: 'lin@aurora.io' },
  { id: 't-2', company: 'BrightMCN', plan: 'enterprise', seats: 48, status: 'active', created: '2025-09-30', contact: 'ops@brightmcn.com' },
  { id: 't-3', company: 'Indie Reels', plan: 'pro', seats: 3, status: 'pending', created: '2026-05-11', contact: 'hi@indiereels.tv' },
  { id: 't-4', company: 'NorthWave', plan: 'starter', seats: 1, status: 'suspended', created: '2025-11-04', contact: 'm@northwave.cn' },
]
...
export const mockAdminModels: AdminModel[] = [
  { id: 'm-1', provider: 'OpenAI', name: 'gpt-5', modality: 'text', status: 'online', latencyMs: 820, pricePerCall: 0.03, apiKeyMasked: 'sk-…f3a1' },
  { id: 'm-2', provider: 'Google', name: 'gemini-2.5-flash-image-preview', modality: 'image', status: 'online', latencyMs: 1640, pricePerCall: 0.02, apiKeyMasked: 'sk-…7c2e' },
  { id: 'm-3', provider: 'Kling', name: 'kling-v3-1080p', modality: 'video', status: 'degraded', latencyMs: 14200, pricePerCall: 0.42, apiKeyMasked: 'sk-…9d10' },
  { id: 'm-4', provider: 'ElevenLabs', name: 'tts-multilingual-v2', modality: 'audio', status: 'online', latencyMs: 480, pricePerCall: 0.005, apiKeyMasked: 'sk-…aa20' },
  { id: 'm-5', provider: 'OpenAI', name: 'sora-1.0', modality: 'video', status: 'offline', latencyMs: 0, pricePerCall: 0.55, apiKeyMasked: 'sk-…0099' },
]
...
export const mockInvoices: Invoice[] = [
  { id: 'inv-2026-04-001', tenant: 'Aurora Studio', amount: 1490, currency: 'USD', period: '2026-04', status: 'paid' },
  { id: 'inv-2026-04-002', tenant: 'BrightMCN', amount: 5980, currency: 'USD', period: '2026-04', status: 'paid' },
  { id: 'inv-2026-05-001', tenant: 'Indie Reels', amount: 49, currency: 'USD', period: '2026-05', status: 'pending' },
  { id: 'inv-2026-05-002', tenant: 'NorthWave', amount: 19, currency: 'USD', period: '2026-05', status: 'failed' },
]
...
export const mockNotifications: Notification[] = [
  { id: 'n-1', ts: '2 min ago', title: 'Render finished', body: 'Lighthouse Reverie — Scene 2 is ready for review.', read: false, kind: 'success' },
  { id: 'n-2', ts: '1 hour ago', title: 'Export pending approval', body: 'Tomás requested a 1080p export.', read: false, kind: 'info' },
  { id: 'n-3', ts: 'yesterday', title: 'Quota at 80%', body: 'You have used 80% of this month\'s points.', read: true, kind: 'warning' },
]
