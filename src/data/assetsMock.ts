...
export const characterAssets: CharacterAsset[] = [
  {
    ...
    role: "女主角",
    age: "17",
    personality: "温柔、敏感、坚定",
    style: "Visual Novel / 校园清新",
    costume: "海军蓝水手服 + 白色领巾，校徽别在左胸口袋",
    appearance:
      "身高 162cm，长直黑发配齐刘海，深紫色瞳孔，皮肤偏白；总是抱着一本写满诗句的小笔记。",
    background:
      "海风高中三年级文学社社员，从小被母亲一人带大，将所有心事都写进诗里；在新生报到那天遇到陈昱后开始第一次悄悄喜欢一个人。",
  ...
  },
  {
    ...
    role: "反派 / 学姐",
    age: "18",
    personality: "高傲、心机、缺爱",
    style: "Visual Novel / 大小姐",
    costume: "深紫色双排扣西装外套 + 白衬衫 + 红色蝴蝶结 + 高跟乐福鞋",
    appearance:
      "身高 168cm，栗棕色大波浪长发，红色瞳孔，唇形分明；指甲永远涂着深红，胸前挂着一枚银色挂坠。",
    background:
      '学生会主席，父母常年缺席的"完美大小姐"；将对爱的渴望转化为对控制的迷恋，不允许任何人靠近陈昱。',
  ...
  },
  {
    ...
    role: "支线 / 班主任",
    age: "42",
    personality: "幽默、唠叨、温暖",
    style: "Visual Novel / 写实暖色",
    costume: "棕色针织背心 + 米白衬衫 + 卷起的袖口 + 棕色西裤",
    appearance:
      "身高 172cm，微胖，鬓角已花白，圆框金属眼镜，常年口袋里揣着红笔与一本卷边的语文课本。",
    background:
      '海风高中高三 2 班班主任兼语文老师，膝下无儿；把每一届学生都当作自己的孩子，是青春故事里的"定海神针"。',
...
export const propAssets: PropAsset[] = [
  {
    ...
    owner: "林夏",
    appearance: "第 1、5、12 集",
    symbol: "初见 / 暗恋的信物",
    material: "亚克力 + 镀银金属",
    firstAppear: "第 1 集 02:14 操场",
    lastAppear: "第 12 集 38:52 天台",
  ...
  },
  {
    ...
    symbol: "父亲遗物 / 内心柔软",
    material: "云杉木 + 玫瑰木指板",
    firstAppear: "第 3 集 21:08 天台",
    lastAppear: "第 8 集 47:30 卧室",
  ...
  },
  {
    ...
    owner: "林夏 → 陈昱",
    appearance: "第 6、11、12 集",
    symbol: "暗恋的具象 / 最终交付",
    material: "压制樱花 + 透明树脂",
    firstAppear: "第 6 集 09:02 图书馆",
    lastAppear: "第 12 集 42:11 操场",
  ...
  },
  {
    ...
    symbol: "反派的脆弱来源",
    material: "925 银 + 黑曜石",
    firstAppear: "第 2 集 14:55 学生会办公室",
    lastAppear: "第 9 集 33:20 雨夜",
